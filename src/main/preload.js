...
'plugins:list','plugins:install','plugins:uninstall','plugins:previewRecipe','plugins:applyRecipe','config:list','config:read','config:write','config:readTheme','config:writeTheme','config:readBackup','config:highlight',
